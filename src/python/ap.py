...
def AP(cosinesm,k_cluster,fcluster):
    #l=cosinesm.shape[0]
    l=len(cosinesm)
    print l
    ...
    print
    graph=cosinesm
    centers, labels = affinity_propagation(graph)
...
if __name__ == '__main__':
	...
	print "starttime=",starttime
        ...
        clusterfile=datafile[0:-4]+"_cs_"+sys.argv[2]+"_ap.txt"
	...
	endtime1=datetime.datetime.now()
        ...
        AP(cosinesm,k_cluster,fcluster)
        fcluster.close()
        ...
        print >>sys.stderr,"argv err! use: ap.py *pageCont*.txt k_cluster"
