...
def Kmeans(cosinesm,k_cluster,fcluster):
    l=cosinesm.shape[0]
    print l
    ...
    print
    graph=cosinesm
    _, labels, _ = k_means(graph, n_clusters=k_cluster)
...
if __name__ == '__main__':
	...
	print "starttime=",starttime
        ...
        clusterfile=datafile[0:-4]+"_cs_"+sys.argv[2]+"_kmeans.txt"
	...
	endtime1=datetime.datetime.now()
        ...
        Kmeans(cosinesm,k_cluster,fcluster)
        fcluster.close()
