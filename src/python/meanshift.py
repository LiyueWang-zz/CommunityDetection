...
def MeanShift(cosinesm,k_cluster,fcluster):
    #l=cosinesm.shape[0]
    l=len(cosinesm)
    print l
    ...
    print
    graph=cosinesm
    centers, labels = mean_shift(graph)
    num_cluster=len(centers)
    clusters=[[] for x in range(num_cluster)]
    print "centers:"
    print centers
    print
    print "labels:"
...
if __name__ == '__main__':
	...
	print "starttime=",starttime
        ...
        clusterfile=datafile[0:-4]+"_cs_"+sys.argv[2]+"_meanshift.txt"
	...
	endtime1=datetime.datetime.now()
        ...
        MeanShift(cosinesm,k_cluster,fcluster)
        fcluster.close()
        ...
        print >>sys.stderr,"argv err! use: meanshift.py *pageCont*.txt k_cluster"
